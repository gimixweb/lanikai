...
$site_top = "http://www.hula-lei.jp/lanikai/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "lanikai@hula-lei.jp";
...
$Referer_check_domain = "hula-lei.jp";
...
$thanksPage = "http://www.hula-lei.jp/lanikai/thanks.html";
...
//配列の形「name="○○[]"」の場合には必ず後ろの[]を取ったものを指定して下さい。
$hankaku_array = array('phone','email');
